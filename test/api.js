...
describe('api', function() {
    ...
    describe('.pRender(options)', function() {
        it('should compile sass to css with file', function() {
            var expected = read(fixture('simple/expected.css'), 'utf8').trim();
        ...
        it('should compile sass to css with data', function() {
            var src = read(fixture('simple/index.scss'), 'utf8');
            var expected = read(fixture('simple/expected.css'), 'utf8').trim();
        ...
        it('should compile sass to css using indented syntax', function() {
            var src = read(fixture('indent/index.sass'), 'utf8');
            var expected = read(fixture('indent/expected.css'), 'utf8').trim();
        ...
        it('should throw error status 1 for bad input', function() {
            return sass.pRender({
                data: '#navbar width 80%;'
            }).catch(function(error) {
                assert(error);
                // if we wanted to verify status, we'd have to do it via regex.  Bluebird by default sends an actual Error object and I'm
                //   not going to spend the time to figure out how to change that or get it to pass objects attached to the error object.
            });
        });

        it('should compile with include paths', function() {
            var src = read(fixture('include-path/index.scss'), 'utf8');
            var expected = read(fixture('include-path/expected.css'), 'utf8').trim();
        ...
        it('should compile with image path', function() {
            var src = read(fixture('image-path/index.scss'), 'utf8');
            var expected = read(fixture('image-path/expected.css'), 'utf8').trim();
        ...
        it('should throw error with non-string image path', function() {
            var src = read(fixture('image-path/index.scss'), 'utf8');
        ...
        it('should render with --precision option', function() {
            var src = read(fixture('precision/index.scss'), 'utf8');
            var expected = read(fixture('precision/expected.css'), 'utf8').trim();
        ...
        it('should contain all included files in stats when data is passed', function() {
            var src = read(fixture('include-files/index.scss'), 'utf8');
            var expected = [
                fixture('include-files/bar.scss').replace(/\\/g, '/'),
                fixture('include-files/foo.scss').replace(/\\/g, '/')
